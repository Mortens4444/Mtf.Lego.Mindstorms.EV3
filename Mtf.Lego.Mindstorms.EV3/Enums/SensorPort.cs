...
public class SensorPort : EnumLikeObject<SensorPort>
{
    ...
    /// 460 Kbit/s
    /// </summary>
    public static readonly SensorPort In1 = new(0x00, nameof(In1));

    /// <summary>
    /// 460 Kbit/s
    /// </summary>
	public static readonly SensorPort In2 = new(0x01, nameof(In2));

    /// <summary>
    /// 230 Kbit/s
    /// </summary>
	public static readonly SensorPort In3 = new(0x02, nameof(In3));

    /// <summary>
    /// 230 Kbit/s
    /// </summary>
	public static readonly SensorPort In4 = new(0x03, nameof(In4));
