...
public class InfraredSensorMode : EnumLikeObject<InfraredSensorMode>
{
    ...
    /// </summary>
    public static readonly InfraredSensorMode ProximityMode = new(0x00, nameof(ProximityMode));
    ...
    /// </summary>
    public static readonly InfraredSensorMode InfraredSeekerMode = new(0x01, nameof(InfraredSeekerMode));

    public static readonly InfraredSensorMode InfraredRemoteMode = new(0x02, nameof(InfraredRemoteMode));
