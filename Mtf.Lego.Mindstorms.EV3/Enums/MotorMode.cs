...
{
	public static readonly MotorMode Degree = new(0x00, nameof(Degree));
	public static readonly MotorMode Rotation = new(0x01, nameof(Rotation));
	public static readonly MotorMode Power = new(0x02, nameof(Power));
