...
{
    private readonly List<SystemCommand> CommandsWithLength = [SystemCommand.BeginFileUpload, SystemCommand.BeginGetFile, SystemCommand.ContinueGetFile, SystemCommand.ListFiles];
    private readonly List<SystemCommand> CommandsWithoutHandle = [SystemCommand.CloseFileHandle, SystemCommand.CreateDir, SystemCommand.DeleteFile, SystemCommand.ListOpenHandles, SystemCommand.BluetoothPin];
